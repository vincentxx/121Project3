...
from nltk.stem.lancaster  import LancasterStemmer  # https://www.datacamp.com/community/tutorials/stemming-lemmatization-python
...
MAXWORDLENGTH = 20
MINWORDLENGTH = 2
TOTAL_NUM_OF_DOC = 500 #37497 #total documents
...
#Hoang added code ---------------START------------------
def writeJSONFile():
    with open("./output/hoang.json",'w') as file:
